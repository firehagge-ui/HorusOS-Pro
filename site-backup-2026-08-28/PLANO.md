...
> **Versões 8 e 9, 26/08/2026.** Duas rodadas grandes guiadas por prints numerados
> do Marcelo. O detalhamento completo do que mudou está em **`site/CLAUDE.md`,
> seção "Estado em 26/08/2026"** — não vou duplicar aqui. Resumo do que este PLANO
> passou a assumir: entrou **GSAP + Lenis** (coreografia de scroll), a tipografia
> virou **Bricolage Grotesque + Hanken Grotesk + Newsreader** (só no site), a home
> ganhou a **esfera que vira logo** (novo elemento-assinatura), os serviços viraram
> **cards bento com imagem 3D** (Higgsfield), entraram **Garantia circular** e
> **Como começa em zigue-zague**, e a chamada + rodapé viraram **um fundo só**.
>
